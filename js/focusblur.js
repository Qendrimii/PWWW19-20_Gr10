...
var helpArray = [ "Shkruaj kerkimin ne kete input box.",
  "Etiketo tagun ne kete input box",
 , "" ];
var helpText;
...
function init()
{
   ...
   // register listeners
   registerListeners(document.getElementById( "query" ), 0 );
   registerListeners(document.getElementById( "tag" ), 1 );
